...
// Model "lite": tersedia untuk API key baru, dan cepat (~500ms). Model flash penuh
// (gemini-2.5-flash) diblokir Google untuk key baru; 2.0-flash kena kuota; 3.5-flash
// lambat (~30s). Urutan = prioritas fallback di klien.
export const ALLOWED_MODELS = ['gemini-2.5-flash-lite', 'gemini-3.1-flash-lite', 'gemini-flash-lite-latest'];
